    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] transition-colors duration-300">
            ...
            <div className="p-8 max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">My Active Plan</h1>
                ...
                {subscriptions.length === 0 ? (
                    <div className="bg-white dark:bg-[#171717] p-8 rounded-lg shadow-md text-center border dark:border-gray-800">
                        ...
                        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No Active Plan</h2>
                        <p className="text-gray-500 dark:text-gray-500 mb-6">You don't have any active subscriptions properly.</p>
                        <button
                    ...
                    <div className="space-y-6">
                        {subscriptions.map(sub => (
                            <div key={sub.id} className="bg-white dark:bg-[#171717] p-6 rounded-lg shadow-md border-t-4 border-green-500 dark:border-green-600 relative overflow-hidden">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">{sub.plan?.title || "Unknown Plan"}</h2>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm bg-gray-50 dark:bg-[#262626] p-4 rounded-md">
                                    ...
                                    <div>
                                        <p className="text-gray-500 dark:text-gray-400">Renews On</p>
